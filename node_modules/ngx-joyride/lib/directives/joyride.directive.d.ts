...
export declare class JoyrideDirective implements AfterViewInit, OnChanges, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<JoyrideDirective, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<JoyrideDirective, "joyrideStep, [joyrideStep]", never, { "stepPosition": "stepPosition"; "name": "joyrideStep"; "nextStep": "nextStep"; "title": "title"; "text": "text"; "stepContent": "stepContent"; "stepContentParams": "stepContentParams"; "prevTemplate": "prevTemplate"; "nextTemplate": "nextTemplate"; "doneTemplate": "doneTemplate"; "counterTemplate": "counterTemplate"; }, { "prev": "prev"; "next": "next"; "done": "done"; }, never>;
}
